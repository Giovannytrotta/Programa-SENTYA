...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        filterUsers(searchQuery, roleFilter, statusFilter, cssFilter)
        setCurrentPage(1)
    ...
    const handleCSSChange = useCallback(async (userId, cssId) => {
        try {
            await updateUserCSS(userId, cssId);
        } catch (error) {
                        ...
                        <div className="overview-section">
                            ...
                            <div className="stats-grid">
                                ...
                                <div className="stat-card">
                                    ...
                                    <div className="stat-info">
                                        <span className="stat-number">{stats.cssCenters}</span>
                                ...
                                <div className="stat-card">
                                    ...
                                    <div className="stat-info">
                                        <span className="stat-number">{stats.withoutCSS}</span>
                                        <span className="stat-label">Sin Centro</span>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <tr key={user.id} className="user-row">
                                                        ...
                                                        <td className="user-css">
                                                            <div className="role-badge css">
                                                                <select
                                                                    value={user.css_id || ''}
                                                                    onChange={(e) => handleCSSChange(user.id, e.target.value)}
                                                                    disabled={loading}
                        ...
                        <form onSubmit={handleRegisterSubmit} className="register-form">
                            ...
                            {currentStep === 3 && (
                                <div className="form-step">
                                    ...
                                    <div className="form-row">
                                        <div className="form-group">
                                            <label htmlFor="css_id">Centro Social *</label>
                                            <select
                                                id="css_id"
                                                value={newUser.css_id || ''}
                                                onChange={(e) => setNewUser(prev => ({ ...prev, css_id: parseInt(e.target.value) }))}
                                                disabled={loading}
                                                required
                                            >
                                    ...
                                    <div className="user-summary">
                                        ...
                                        <div className="summary-grid">
                                            ...
                                            <div className="summary-item">
                                                <span className="summary-label">Centro Social:</span>
                                                <span className="summary-value">
                                                    {newUser.css_id ?
                                                        cssCenters.find(css => css.id === parseInt(newUser.css_id))?.name || 'Centro seleccionado'
                                                        : 'No seleccionado'
                                                    }
                                                </span>
                                            </div>
